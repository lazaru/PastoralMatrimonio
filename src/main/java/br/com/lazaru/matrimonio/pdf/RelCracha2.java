...
//		PDFont fontMono = PDType1Font.COURIER;
		...
		for (CasalBase e : casais) {
			...
			if ((e.getPrimeiroNomeHomem() != null) && (!e.getPrimeiroNomeHomem().isEmpty())) {
				...
				if ((e.getPrimeiroNomeMulher() != null) && (!e.getPrimeiroNomeMulher().isEmpty())) {
					cellHtml.append("<b>").append(e.getPrimeiroNomeHomem()).append("</b><br/><br/>");
					cellHtml.append("Da<br/><br/>").append("<b>").append(e.getPrimeiroNomeMulher()).append("</b><br/><br/>");
				} else {
					cellHtml.append("<br/><br/><b>").append(e.getPrimeiroNomeHomem()).append("</b><br/><br/><br/><br/>");
...
//				cell.setFontSize(15);
			...
			if ((e.getPrimeiroNomeMulher() != null) && (!e.getPrimeiroNomeMulher().isEmpty())) {
				...
				StringBuilder cellHtml = new StringBuilder("Paróquia N. Srª Das Dores Preparação dos Noivos<br/><br/>");
				if ((e.getPrimeiroNomeHomem() != null) && (!e.getPrimeiroNomeHomem().isEmpty())) {
					cellHtml.append("<b>").append(e.getPrimeiroNomeMulher()).append("</b><br/><br/>");
					cellHtml.append("Do<br/><br/>").append("<b>").append(e.getPrimeiroNomeHomem()).append("</b><br/><br/>");
				} else {
					cellHtml.append("<br/><br/><b>").append(e.getPrimeiroNomeMulher()).append("</b><br/><br/><br/><br/>");
					//cellHtml.append("<br/><br/><br/>");
				}
